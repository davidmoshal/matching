...
internal class `Aggressor partial filled passive filled` : FeatureSpec({
    val bookId = aBookId()

    feature("Aggressor partial filled passive filled") {
        forall(
    ...
    feature("Aggressor partial filled passive filled, rest of aggressor size cancelled") {
        forall(
