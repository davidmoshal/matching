...
internal class `Aggressor filled passive partial filled` : FeatureSpec({
    val bookId = aBookId()

    feature("Aggressor filled passive partial filled") {
        forall(
            row(BUY, Tuple4(LIMIT, GOOD_TILL_CANCEL, 17, 9L), Tuple4(LIMIT, GOOD_TILL_CANCEL, 11, 8L), 11, 9L, 6),
            row(BUY, Tuple4(LIMIT, GOOD_TILL_CANCEL, 17, 9L), Tuple4(LIMIT, GOOD_TILL_CANCEL, 11, 9L), 11, 9L, 6),
            row(BUY, Tuple4(LIMIT, GOOD_TILL_CANCEL, 17, 9L), Tuple4(LIMIT, IMMEDIATE_OR_CANCEL, 11, 8L), 11, 9L, 6),
            row(BUY, Tuple4(LIMIT, GOOD_TILL_CANCEL, 17, 9L), Tuple4(LIMIT, IMMEDIATE_OR_CANCEL, 11, 9L), 11, 9L, 6),
            row(SELL, Tuple4(LIMIT, GOOD_TILL_CANCEL, 17, 9L), Tuple4(LIMIT, GOOD_TILL_CANCEL, 11, 10L), 11, 9L, 6),
            row(SELL, Tuple4(LIMIT, GOOD_TILL_CANCEL, 17, 9L), Tuple4(LIMIT, GOOD_TILL_CANCEL, 11, 9L), 11, 9L, 6),
            ...
            scenario(
                "Given the book has a $oldSide ${old.a} ${old.b.code} order ${old.c} at ${old.d}, " +
                        "when a ${oldSide.oppositeSide()} ${new.a} ${new.b.code} order ${new.c} at ${new.d} is placed, " +
                        "then the trade is executed $expectedTradeSize at $expectedTradePrice"
            ) {
