...
internal class `Aggressor order partial filled and passive quote filled and remaining cancelled to book` : StringSpec({
    val bookId = aBookId()

    forall(
        row(
            List.of(Tuple4(6, 11L, 6, 12L), Tuple4(7, 10L, 7, 13L)),
            Tuple5(BUY, LIMIT, IMMEDIATE_OR_CANCEL, 8, 12L),
            1, 6, 12L, 2
        )
