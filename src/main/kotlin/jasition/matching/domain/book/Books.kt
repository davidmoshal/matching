...
data class Books(
    ...
    fun addBookEntry(entry: BookEntry, eventId: EventId = entry.key.eventId): Books =
        copy(
    ...
    fun removeBookEntries(entries: Seq<BookEntry>, eventId: EventId): Books =
        copy(
...
infix fun Books.verifyEventId(eventId: EventId) :EventId =
